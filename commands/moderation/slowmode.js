...
module.exports = {
	...
	async execute(client, interaction) {
        ...
        const oldDuration = interaction.channel.rateLimitPerUser == 0 ? 'disabled' : client.sToHMS(interaction.channel.rateLimitPerUser)
        ...
        if (isNaN(newDuration)) {
            ...
            .addField('New rate limit', `${newDuration == 0 ? 'disabled' : client.sToHMS(newDuration)}`)      
            .setColor('#FF8A33')
